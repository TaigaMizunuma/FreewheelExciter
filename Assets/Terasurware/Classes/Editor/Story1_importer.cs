...
public class Story1_importer : AssetPostprocessor
{
    private static readonly string filePath = "Assets/Saito/Resources/Data/Story1.xlsx";
    private static readonly string[] sheetNames = { "Story1", };
        ...
        foreach (string asset in importedAssets)
        {
            ...
            using (FileStream stream = File.Open (filePath, FileMode.Open, FileAccess.Read, FileShare.ReadWrite))
            {
                ...
                foreach (string sheetName in sheetNames)
                {
                    ...
                    var data = (Entity_Story1)AssetDatabase.LoadAssetAtPath(exportPath, typeof(Entity_Story1));
                    if (data == null)
                    {
                        data = ScriptableObject.CreateInstance<Entity_Story1>();
